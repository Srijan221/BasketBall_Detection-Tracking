...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='./IO_data/input/45248-45436.avi', help='input video path')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='./IO_data/output/45248-45436.avi', help='output video path')  # file/folder, 0 for webcam
    parser.add_argument('--show_live', action='store_true', default=False, help='display video')
    parser.add_argument('--count_objects', action = 'store_true', default=False, help='count objects tracked')
    parser.add_argument('--verbose', default=2, help='verbose 0,1,2')
    parser.add_argument('--graph', default = "3D", help='show graph 2D,3D')
    parser.add_argument('--draw_line', action = 'store_true', default=False, help='draw live trajectory')
