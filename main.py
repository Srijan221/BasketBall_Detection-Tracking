...
if __name__ == '__main__':
    ...
    parser.add_argument('--show_live', action='store_false', default=True, help='to display video')
    parser.add_argument('--count_objects', action = 'store_false', default=True, help='To count objects tracked')
    parser.add_argument('--verbose', default=2, help='verbose 0,1,2')
    parser.add_argument('--graph', default = "3D", help='show graph 2D,3D')
    parser.add_argument('--draw_line', action = 'store_false', default=True, help='To draw live trajectory')
